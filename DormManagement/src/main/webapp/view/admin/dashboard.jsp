        ...
        <div class="col-md-3 col-lg-2 px-0 sidebar">
            <div class="p-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link ${empty showBuildings ? 'active' : ''}" href="dashboard.jsp">
                            <i class="bi bi-speedometer2"></i> Tổng Quan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ${showBuildings ? 'active' : ''}" href="${pageContext.request.contextPath}/BuildingController?action=list">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/invoices">
                            <i class="bi bi-receipt"></i> Hóa Đơn
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/register-forms">
